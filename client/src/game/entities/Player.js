...
export class Player {
    constructor(app, sheet, state, positions, damageIndicator, confirmButton, isPlayer) {
        ...
        this.jokerLeft = new Joker(this.cardsContainer, this.sheet, this.isPlayer? "J1" : "J2", this.isPlayer? "B1" : "B2", state.cards.jokerLeft, this.positions.jokerLeft);
        this.jokerRight = new Joker(this.cardsContainer, this.sheet, this.isPlayer? "J1" : "J2", this.isPlayer? "B1" : "B2", state.cards.jokerRight, this.positions.jokerRight);
